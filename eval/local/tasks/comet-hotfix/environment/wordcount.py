"""Simple word count CLI tool - BUGGY VERSION.

BUG: count_lines() counts words instead of lines.
"""
...
def count_lines(text: str) -> int:
    ...
    BUG: This function incorrectly counts words instead of lines.
    """
    # BUG: should be len(text.splitlines()) but uses split() instead
    return len(text.split())
